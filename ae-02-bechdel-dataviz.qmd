...
ggplot(bechdel, aes(x = budget_2013, y = gross_2013, colour = binary, size = roi, alpha = 0.5)) +
  geom_point() + 
  labs(
    x = "Budget (in 2013 $)", 
    y = "Gross revenue (in 2013 $)", 
...
This does not seem useful, as the colours already made the pass/fail easy to visualize. This is now much more condensed and difficult to read.
...
ggplot(data = bechdel, 
       aes(x = clean_test, y = roi, colour= binary)) +
  geom_boxplot() +
  labs(
...
Paranormal Activity, the Blair Witch Project, and El Mariachi.
...
Movies that pass the Bechdel test may perform slightly better in ROI, but overall other movies do not perform better or worse than them on average either.
